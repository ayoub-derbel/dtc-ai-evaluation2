...
def export_pdf(results: list[dict[str, str]], pdf_path: Path) -> None:
    ...
    pdf.drawString(x_margin, y, "OBD2 AI Benchmark Report - DeepSeek")
    y -= 24
...
def main() -> None:
    ...
    results_path = project_root / "results" / "responses_deepseek.json"
    pdf_path = project_root / "results" / "responses_deepseek_report.pdf"
